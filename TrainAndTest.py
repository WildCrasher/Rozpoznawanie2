...
def main():
    ...
    while (cap.isOpened()):  #bylo true
        ...
        if klatki == 100:
            ...
            imgContours, npaContours, npaHierarchy = cv2.findContours(imgBlurred,             # input image, make sure to use a copy since the function will modify this image in the course of finding contours
